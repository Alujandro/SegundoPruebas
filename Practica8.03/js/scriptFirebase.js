...
//Función que envía el contenido del formulario a anadeLista y luego vacía el contenido
const sendLista= () =>{
...
//Obtención de documentos
  ...
  const muestraProductos = async (id) => {
    document.getElementById("acciones").innerHTML=plantillas.botAcciones();
    listaActiva=id;
...
//Comprobación de la existencia de usuarios
  ...
  //Función al iniciar el programa
  const inicio=() => {
